<template>
  <main class="overflow-hidden ">
    ...
    <div class="breadcrumb-area" style="background-image: url(src/assets/images/inner-pages/iner.jpg);">
      <div class="container">
        <div class="row">
          <div class="col-xl-12">
            <div class="breadcrumb-content pb-60 text-center wow fadeInUp animated">
              ...
              <div class="breadcrumb-menu">
                <ul>
                  ...
                  <li class="active">Автозапчасти</li>
                </ul>
              </div>
            </div>
          </div>
              ...
              <div class="sidebar-holder">
                ...
                <div class="single-sidebar-box mt-30 wow fadeInUp animated ">
                  ...
                  <div class="checkbox-item">
                    <form>
                      <div v-for="category in categories" class="form-group"> <input type="checkbox"> <label
                          for="bedroom">{{ category.title }}</label> </div>
                    </form>
                  </div>
                </div>
                <div class="single-sidebar-box mt-30 wow fadeInUp animated">
